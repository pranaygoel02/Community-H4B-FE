...
function SingleCommunity() {
  ...
  return (
    <section className="  pt-5 bg-neutral">
      <label className="my-5 container-padding-mini text-xl">
        <b>
      ...
      <section className=" box-mo mt-5  ">
        <section className="py-5 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 items-center gap-8 container-padding-mini box-border-event bg-light ">
          <div className="space-y-8 md:col-span-2 lg:col-span-3">
            ...
            <p className="">{communityInfo.description}</p>
          </div>
          <img
        ...
        <section className="py-5 shadow-2xl shadow-yellow bg-greenlight grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 items-center gap-8  box-border-event container-padding-mini">
          <div className="space-y-8 md:col-span-2 lg:col-span-3">
            <div className="adjust-item gap-5 ">
              <h1 className="font-bold text-4xl flex flex-row items-center gap-5">
                Interested?
              </h1>
            </div>
            <p className="">
            ...
            <div className="flex flex-row justify-start gap-5 ">
              ...
              <button className="btn-sec bg-primary text-white">
                Join Now
              </button>
            </div>
          </div>
